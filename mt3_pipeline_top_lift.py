...
class MT3Pipeline:
    ...
    def step7_execute(self, aligned):
        ...
        rospy.set_param('/sawyer_auto_grasp/skip_after_close_replay', True)
        ...
        if self.dry_run:
            ...
            script_hint = ("mt3_sawyer_place.py" if self.task_type == "pick_place"
                          else "mt3_sawyer_grasp_top_lift.py")
        ...
        try:
            ...
            if self.task_type == "pick_place":
                ...
                exec_script = os.path.join(ros_ws_src, "mt3_sawyer_grasp_top_lift.py")
                script_label = "GraspTopLift"
